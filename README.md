...
![Obstacle Wrapping Demo](example/ss/1_v.gif)
...
![Obstacle Wrapping Demo](example/ss/1.png)
...
![ShrinkWrapText Demo](example/ss/2.png)
...
![BalancedText Demo](example/ss/3.png)
...
![CustomShapes Demo](example/ss/4_v.gif)
